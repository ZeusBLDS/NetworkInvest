  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <a 
        ...
        className="w-full bg-[#25D366] hover:bg-[#128C7E] text-white rounded-3xl p-5 flex items-center justify-between group active:scale-[0.98] transition-all shadow-lg shadow-emerald-100/50"
      >
        <div className="flex items-center space-x-4">
          ...
          <div className="text-left">
            <p className="text-[10px] text-white/90 font-black uppercase tracking-widest">Grupo Oficial</p>
            <p className="font-bold text-white text-base">Comunidade VIP</p>
          </div>
        </div>
        <div className="bg-white/30 text-white px-4 py-1.5 rounded-xl text-xs font-black uppercase">
          ENTRAR
        </div>
      </a>
      ...
      <button 
        onClick={onOpenWheel}
        className="w-full bg-white rounded-3xl p-4 border border-emerald-100 shadow-sm flex items-center justify-between group active:scale-[0.98] transition-all"
      >
        <div className="flex items-center space-x-3">
          <div className="bg-emerald-50 p-2 rounded-2xl group-hover:bg-emerald-100 transition-colors">
            <span className="text-2xl">🎰</span>
          </div>
          <div className="text-left">
            <p className="text-[10px] text-emerald-600 font-bold uppercase tracking-wider">Bônus Extra</p>
      ...
      <div className="bg-white rounded-3xl p-5 border border-gray-100 shadow-sm flex items-center justify-between">
        <div className="flex items-center space-x-4">
          ...
          <div>
            <p className="text-[10px] text-gray-400 font-black uppercase tracking-widest">Plano em Operação</p>
            <p className="font-bold text-gray-900 text-lg">{activePlan ? activePlan.name : 'VIP 0 (Gratuito)'}</p>
          </div>
        </div>
      ...
      <div className="space-y-3">
        <h3 className="text-[10px] font-black text-gray-400 uppercase flex items-center px-1 tracking-widest">
          Documentação & Guias
        </h3>
          ...
          {pdfLinks.map((pdf, idx) => (
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <span className="font-bold text-gray-700 text-sm">{pdf.title}</span>
              </div>
